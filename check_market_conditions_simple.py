"""
Simple Market Conditions Analyzer for Testing
Simulates market analysis without requiring ccxt
"""
...
class SimpleMarketAnalyzer:
    ...
    def generate_market_snapshot(self):
        ...
        ml_features = {
            'spread_stability_norm_100': 1 - (spread_bps / 10),  # Normalize
...
def main():
    ...
    # Run quick analysis (30 seconds for testing)
